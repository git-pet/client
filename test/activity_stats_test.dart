...
void main() {
  test('parses merged activity-stats endpoint responses', () {
    final stats = ActivityStats.fromJson({
      ...
      'breakdown': [
        {'event_type': 'commit', 'total_xp': 20},
        {'event_type': 'pull_request', 'total_xp': 30},
      ],
    });
    ...
    expect(stats.events.map((event) => event.value), [20, 30]);
  });
}
